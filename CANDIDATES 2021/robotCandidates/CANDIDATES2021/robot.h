...
class robot {
  public:
    ...
    const int TiempoCasilla=505; //Establecer tiempo que tarda en avanzar una casilla
...
int robot::readColorIzq(){
  ...
  Serial.print("  --  Int Z2 "+ String(A2));
    ...
    if(R2 < V2 && V2 < A2 && R2 > 2 && R2 < 7){
      ...
      lcd.print("IZQ NEGRO");
      color = negro;
    }else if(R2 < V2 && V2 > A2 && V2 > 7 && V2 < 22){
      Serial.print("  EL COLOR ES ROSA");          
      lcd.print("IZQ ROSA");
      color = rosa;
    }else if(R2 > V2 && V2 < A2 && R2 > 10 && R2 < 28){
...
int robot::readColorDer(){
  ...
  Serial.print("  --  Int Z1 "+ String(A));
    ...
    if(R < V && V > A && V > 2 && V < 9){
      ...
      lcd.print("DER NEGRO");
      color = negro;
    }else if(R < V && V > A && V > 7 && V < 18){
      Serial.print("  EL COLOR ES ROSA"); 
      lcd.print("DER ROSA");         
      color = rosa;
    }else if(R> V && V > A && R > 10&& R < 30){
      Serial.print("  EL COLOR ES VERDE");
      lcd.print("DER VERDE");          
      color = verde;
    }else{
